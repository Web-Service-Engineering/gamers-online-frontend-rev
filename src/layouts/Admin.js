...
const Admin = (props) => {
    ...
    return (
        <UserProfileContext.Provider value={{ firstNameContext, lastNameContext, setFirstNameContext, setLastNameContext }}>
            <>
                <Sidebar
                    {...props}
                    routes={routes}
                    logo={{
                        ...
                        imgSrc: require("../assets/img/brand/game-online-log.png"),
                        imgAlt: "...",
                    }}
                />
